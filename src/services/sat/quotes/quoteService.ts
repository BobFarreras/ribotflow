 ...
 * Path: src/services/sat/quotes/quoteService.ts
 * Description: Business logic for quotes (CRUD + workflow).
 *              Calculations in quoteCalculations.ts.
 *              Number generation in quoteNumber.ts.
 */
...
import { calculateItemTotals, calculateQuoteTotals } from "./quoteCalculations";
