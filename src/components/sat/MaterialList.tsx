    ...
    <div className="flex h-full flex-col">
      ...
      {materials.length === 0 ? (
        <div className="flex flex-1 flex-col items-center justify-center text-[var(--text-muted)]">
          <Package className="mb-1 h-4 w-4 opacity-50" />
            ...
            return (
              ...
              >
                <div className="min-w-0 flex-1">
                  <p className="truncate text-xs font-medium text-[var(--text)]">{m.name}</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={isPending}
                    className="rounded p-0.5 text-[var(--text-muted)] transition-colors hover:bg-red-50 hover:text-red-500 disabled:opacity-50"
                  >
