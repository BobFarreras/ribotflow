        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <tbody>
            <tr>
              ...
              <td style={{ padding: "8px 10px", fontSize: "10pt", textAlign: "right" }}>{totals.subtotal.toFixed(2)} €</td>
            </tr>
            {totals.discountPercent > 0 && (
              <tr>
                <td style={{ padding: "8px 10px", fontSize: "10pt", color: "#16a34a" }}>Descompte ({totals.discountPercent}%):</td>
                <td style={{ padding: "8px 10px", fontSize: "10pt", textAlign: "right", color: "#16a34a" }}>-{totals.discountAmount.toFixed(2)} €</td>
              </tr>
            )}
            <tr>
              <td style={{ padding: "8px 10px", fontSize: "10pt", color: "#475569" }}>IVA ({totals.taxRate}%):</td>
              <td style={{ padding: "8px 10px", fontSize: "10pt", textAlign: "right" }}>{totals.taxAmount.toFixed(2)} €</td>
            </tr>
            <tr>
